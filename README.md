...
| | | |
|---|---|---|
| [**multi-agent-council**](https://github.com/gabrielcnb/multi-agent-council) | MCP server that gets GPT, Gemini, and Claude to debate each other | Python |
...
`Python` · `TypeScript` · `React` · `Next.js` · `React Native` · `FastAPI` · `Node.js` · `PostgreSQL` · `Prisma` · `Docker`

---

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/gabrielcnb)